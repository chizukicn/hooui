      ...
      return <div class="w-full p-4">
        <HiConfigProvider icon={{ size: 96 }}>
          ...
          <HiTabs
            ...
            modelValue={selectedIndex.value} class="mt-12">
          ...
          <div class="flex space-x-4 items-center">
            <HiSwitch as="span" modelValue={selectionState.multiple} class="cursor-pointer mt-4 duration-200 select-none" activeClass="text-hex-f00">Multiple</HiSwitch>
            <HiSwitch as="span" modelValue={selectionState.clearable} class="cursor-pointer mt-4 duration-200 select-none" activeClass="text-hex-f00">Clearable</HiSwitch>
          </div>
